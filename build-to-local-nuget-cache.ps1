<#
.SYNOPSIS
    Builds and installs NexusMods.Cascade projects to the local NuGet cache.
.DESCRIPTION
    This script builds and packages the NexusMods.Cascade projects with
...
$Projects = @(
    "src/NexusMods.Cascade/NexusMods.Cascade.csproj",
    "src/NexusMods.Cascade.SourceGenerator/NexusMods.Cascade.SourceGenerator.csproj"
)
